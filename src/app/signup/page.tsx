        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-zinc-400">
              Join thousands of traders consistently winning with data.
            </p>
          </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="John" {...field} className="bg-black/50 border-white/10 text-white placeholder:text-zinc-600 focus:border-blue-500/50" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      <div className="hidden lg:flex flex-col justify-center items-center relative overflow-hidden bg-zinc-900 border-l border-white/5">
        ...
        <div className="relative z-10 max-w-lg text-center px-8">
          <div className="relative mb-8 group">
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200" />
            <div className="relative aspect-video rounded-xl bg-black border border-white/10 shadow-2xl overflow-hidden flex items-center justify-center">
              <div className="text-zinc-700 font-mono text-sm">[ Analytics Engine Ready ]</div>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-white mb-4">"Finally, a journal that keeps up with my execution."</h2>
          <div className="flex items-center justify-center gap-2 text-zinc-400 text-sm">
            <span className="w-8 h-[1px] bg-zinc-700" />
            <span>Join the 1% Club</span>
            <span className="w-8 h-[1px] bg-zinc-700" />
          </div>
        </div>
      </div>
